...
public class BestEffortTests {
    ...
    //--------------------------------------------------------------------------------------------------------------------
    @Test
    void estadistica_sin_despachar(){
        Traslado[] nuevos = new Traslado[] {
            new Traslado(1, 3, 4, 1, 7),
            new Traslado(7, 6, 5, 40, 6),
            new Traslado(6, 5, 6, 3, 5),
    ...
    @Test
    void estadistica_dos_con_igual_valor(){
        Traslado[] nuevos = new Traslado[] {
            new Traslado(1, 3, 4, 1, 7),
            new Traslado(7, 6, 5, 40, 6),
            new Traslado(6, 5, 6, 3, 5),
        ...
        assertSetEquals(new ArrayList<>(Arrays.asList(4, 6)), sis.ciudadesConMayorGanancia());
    }
@Test
    void estadistica_uno_id_menor(){
        Traslado[] nuevos = new Traslado[] {
            new Traslado(1, 3, 4, 1, 7),
            new Traslado(7, 6, 5, 40, 6),
            new Traslado(6, 5, 6, 3, 5),
    ...
    @Test
    void estadistica_con_ids_no_contiguos(){
        Traslado[] nuevos = new Traslado[] {
